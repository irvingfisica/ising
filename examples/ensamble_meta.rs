...
use std::error::Error;
use common::simulacion_sqgrids::construir_temps_propors;
use common::simulacion_sqgrids::simular_temperatura_proporcion;
use common::simulacion_sqgrids::{condiciones,crear_carpeta_ejecucion,crear_sistema_base};
